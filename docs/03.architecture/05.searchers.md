---
title: Searchers
description: Searchers are used to lookup and scan objects in the ledger.
---

## Overview

Searchers are used to lookup and scan objects in the ledger. A searcher takes a `client`, `query` string and optional
`pagination` hash. For example, to search customer’s by name:
