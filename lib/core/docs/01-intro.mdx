import Installation  from './03-getting-started/_installation.md'
...
Visit the [Quick Start Guide](03-getting-started/02-quick-start.md) to perform your first operation.
